    ...
    render () {
        if (this.props.studentAndTheirCampus) { //This code will run after the initial render, after the dispatch/store updates
            ...
            if (this.props.studentAndTheirCampus[0].campusInfo) { //This is checking if the student is enrolled to a campus
              var renderSingleCampus = <SingleCampus key={this.props.studentAndTheirCampus[0].campusInfo[0].id} listId={this.props.studentAndTheirCampus[0].campusInfo[0].id} name={this.props.studentAndTheirCampus[0].campusInfo[0].name} image={this.props.studentAndTheirCampus[0].campusInfo[0].imageUrl} />
            } else {
